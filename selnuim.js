...
async function testHerokuappLogin() {
    ...
    try {
        ...
        // Find the username input field and enter the text
        let usernameField = await driver.findElement(By.xpath("//input[@id='username']"));
        await usernameField.sendKeys('tomsmith12');
        
        // Find the password input field and enter the text
        ...
        if (messageText.includes('You logged into a secure area!')) {
            ...
            // --- SCREENSHOT CODE ---
            // Capture the screenshot of the success page
            ...
            // --- LOGOUT CODE ---
            // 6. Click the Logout button to finish the workflow cleanly
            let logoutButton = await driver.findElement(By.xpath("//*[@id='content']/div/a/i"));
            await logoutButton.click();
            console.log('Logout successful! 👋');
            
        } else {
            console.log('Login message found, but text did not match. Got:', messageText);
        }
